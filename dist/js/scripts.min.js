...
function fetchMoveList(characterIndex) {
    ...
    .then(function(moves) {
        ...
        __WEBPACK_IMPORTED_MODULE_2__view_js__["a" /* renderMoveList */](moves, state.get('buttonLayout'));
...
function parseMoveList(data) {
    ...
    return data.moves.map((move) => {
        return new __WEBPACK_IMPORTED_MODULE_6__move_js__["a" /* default */](move, lang, ctrlsMap, hitsMap);
    });
}
...
function filterMoveList() {
    ...
    __WEBPACK_IMPORTED_MODULE_2__view_js__["a" /* renderMoveList */](filteredMoveList, state.get('buttonLayout'));
}
