...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__move_js__ = __webpack_require__(3);
/*!
 * =============================
 * =	Mike Pinto             =
 * =	mspkvp@github.com      =
...
function fetchMoveList(characterIndex) {
    ...
    .then(function(moves) {
        ...
        __WEBPACK_IMPORTED_MODULE_2__view_js__["a" /* renderMoveList */](moves, buttonLayouts[buttonLayoutChoice]);
...
function parseMoveList(data) {
    ...
    return data.moves.map((move) => {
        return new __WEBPACK_IMPORTED_MODULE_6__move_js__["a" /* default */](move, lang, jap, ctrlsMap, hitsMap);
    });
}

function filterMoveList() {
    let selectedCharacter  = state.get('selectedCharacter');
    let filteredMoveList   = __WEBPACK_IMPORTED_MODULE_3__filters_js__["a" /* filterMoveList */](state.get('currentMoveList'));
    let buttonLayouts      = state.get('buttonLayouts');
    let buttonLayoutChoice = state.get('buttonLayoutChoice');

    selectCharacter(selectedCharacter);
    __WEBPACK_IMPORTED_MODULE_2__view_js__["a" /* renderMoveList */](filteredMoveList, buttonLayouts[buttonLayoutChoice]);
}
