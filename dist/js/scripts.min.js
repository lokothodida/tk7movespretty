...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filters_js__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__move_js__ = __webpack_require__(2);
/*!
 * =============================
 * =	Mike Pinto             =
 * =	mspkvp@github.com      =
...
let state = new __WEBPACK_IMPORTED_MODULE_4__state_js__["a" /* default */]();
...
function importData() {
    ...
    .then(() => {
        ...
        __WEBPACK_IMPORTED_MODULE_1__view_js__["a" /* renderCharacterList */](characterList, selectedCharacter);
        fetchMoveList(selectedCharacter);
    });
}

function loadHitsMap() {
    return Object(__WEBPACK_IMPORTED_MODULE_3__utils_js__["b" /* loadJson */])("./assets/data/map_hits.json")
    .then(function(data) {
        let hitsMap = {};
...
function loadControlsMap() {
    return Object(__WEBPACK_IMPORTED_MODULE_3__utils_js__["b" /* loadJson */])("./assets/data/map_ctrls.json")
...
function loadCharacterList() {
    return Object(__WEBPACK_IMPORTED_MODULE_3__utils_js__["b" /* loadJson */])("./assets/data/map_chars.json")
    .then(function(data) {
        let characterData = [];
...
function loadMoveList(characterIndex) {
    return Object(__WEBPACK_IMPORTED_MODULE_3__utils_js__["b" /* loadJson */])("./assets/data/movelists/MOVELIST_" + characterIndex + ".json")
        .then(parseMoveList);
}
...
function fetchMoveList(characterIndex) {
    ...
    .then(function(moves) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__view_js__["c" /* renderSelectedCharacterName */](characterList[characterIndex].n);
        __WEBPACK_IMPORTED_MODULE_1__view_js__["a" /* renderCharacterList */](sortCharacterList(characterList), characterIndex);
        __WEBPACK_IMPORTED_MODULE_1__view_js__["b" /* renderMoveList */](moves, state.get('buttonLayout'));
...
function filterMoveList() {
    let filteredMoveList = __WEBPACK_IMPORTED_MODULE_2__filters_js__["a" /* filterMoveList */](state.get('currentMoveList'));

    __WEBPACK_IMPORTED_MODULE_1__view_js__["b" /* renderMoveList */](filteredMoveList, state.get('buttonLayout'));
}
