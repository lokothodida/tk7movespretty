...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["e"] = getMoveString;
/* harmony export (immutable) */ __webpack_exports__["f"] = getMoveThrowBreak;
/* harmony export (immutable) */ __webpack_exports__["h"] = moveHasSpin;
/* harmony export (immutable) */ __webpack_exports__["g"] = moveHasArmor;
/* harmony export (immutable) */ __webpack_exports__["i"] = moveHasTracking;
/* harmony export (immutable) */ __webpack_exports__["c"] = commandInputIsMovement;
/* harmony export (immutable) */ __webpack_exports__["d"] = commandInputIsNeutral;
/* harmony export (immutable) */ __webpack_exports__["b"] = commandInputIsHeld;
/* harmony export (immutable) */ __webpack_exports__["a"] = commandInputIsAttack;
...
function commandInputIsMovement(input) {
    return input && Object(__WEBPACK_IMPORTED_MODULE_0__utils_js__["a" /* isLetter */])(input);
}

function commandInputIsNeutral(input) {
    return input === "N";
}

function commandInputIsHeld(input) {
    return input && input === input.toUpperCase();
}

function commandInputIsAttack(input) {
...
function renderMoveCommand(command, ctrlsMap, buttonLayout) {
    return command.split("").map((char) => {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2__move_js__["c" /* commandInputIsMovement */](input) || __WEBPACK_IMPORTED_MODULE_2__move_js__["d" /* commandInputIsNeutral */](input)) {
            return `<img class="move-arrow" src="./assets/arrow/${input.toLowerCase()}.svg">`;
        } else if (__WEBPACK_IMPORTED_MODULE_2__move_js__["c" /* commandInputIsMovement */](input) && __WEBPACK_IMPORTED_MODULE_2__move_js__["b" /* commandInputIsHeld */](input)) {
            return `<img class="move-arrow" src="./assets/arrow/${input.toLowerCase()}p.svg">`;
        } else if (__WEBPACK_IMPORTED_MODULE_2__move_js__["a" /* commandInputIsAttack */](input)) {
...
function renderThrowBreaks(move) {
    ...
    <p class="mv-hitlvl">
        ${move.br[0].f}F BREAK ${__WEBPACK_IMPORTED_MODULE_2__move_js__["f" /* getMoveThrowBreak */](move)}
    </p>
    `
}
    ...
    <div class="move-extra">
        <div class="mv-section">
            <div class="move-special">
                ${ __WEBPACK_IMPORTED_MODULE_2__move_js__["h" /* moveHasSpin */](move) ? `<p class="spin">SPIN</p>` : `` }
                ${ __WEBPACK_IMPORTED_MODULE_2__move_js__["g" /* moveHasArmor */](move) ? `<p class="armor">ARMOR</p>` : `` }
                ${ __WEBPACK_IMPORTED_MODULE_2__move_js__["i" /* moveHasTracking */](move) ? `<p class="track">TRACK</p>` : `` }
            </div>
...
function filterMoveList(currentMoveList, jap, lang, ctrlsMap) {
	...
	return currentMoveList.filter(function(move) {
		let moveString  = Object(__WEBPACK_IMPORTED_MODULE_0__move_js__["e" /* getMoveString */])(move, lang, ctrlsMap);
