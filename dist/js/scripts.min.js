...
function importData() {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_3__utils_js__["b" /* loadJson */])("./assets/data/map_hits.json").then(function(data) {
        ...
        let table = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](".char-menu > .inner-table > table");
        ...
        data.forEach((character) => {
            ...
            __WEBPACK_IMPORTED_MODULE_0_d3__["select"]("#"+ character.c.split(" ")[0]).on("click", function() {
...
function fetchMoveList(characterIndex) {
    Object(__WEBPACK_IMPORTED_MODULE_3__utils_js__["b" /* loadJson */])("./assets/data/movelists/MOVELIST_" + characterIndex + ".json")
    .then(parseMoveList)
    .then(function(moves) {
        selectCharacter(characterIndex);
        state.set('currentMoveList', moves);

        __WEBPACK_IMPORTED_MODULE_1__view_js__["a" /* renderMoveList */](moves, state.get('buttonLayout'));
...
function filterMoveList() {
    ...
    __WEBPACK_IMPORTED_MODULE_1__view_js__["a" /* renderMoveList */](filteredMoveList, state.get('buttonLayout'));
}
